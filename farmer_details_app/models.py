...
class Vendor(BaseModel):
    ...
    profile_image = models.ImageField(_("Profile image"), upload_to='vendor/profile_image')
    ...
    role = models.CharField(verbose_name=_("Role (Ginning/Spinning)"), max_length=50, choices=ROLE_CHOICES)
    ...
    identification_type = models.CharField(verbose_name=_("Identification Type"), max_length=100, choices=ID_TYPE_CHOICES)
    identification_number = models.IntegerField(verbose_name=_("Identification Number"),)
    identification_file = models.FileField(verbose_name=_("Identification File"), upload_to='vendor/identification', null=True, blank=True)
...
class SelectedGinningFarmer(BaseModel):
    farmer_name = models.CharField(verbose_name=_("Farmer Name"), max_length=200, null=True, blank=True)
    farmer = models.ForeignKey(Farmer, related_name="ginning_farmer", on_delete=models.PROTECT, null=True, blank=True)
    quantity = models.IntegerField(verbose_name=_("Quantity"), )
    

class GinningMapping(BaseModel):
    vendor = models.ForeignKey(Vendor, verbose_name=_("Vendor"), on_delete=models.CASCADE)
    selected_farmers = models.ManyToManyField(SelectedGinningFarmer, verbose_name=_("Selected farmers"), related_name="ginning_mapping")
